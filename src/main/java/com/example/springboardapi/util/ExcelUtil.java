...
public class ExcelUtil {
    public static List<Map<Object, Object>> readExcel(MultipartFile uploadFile) throws IOException {
    ...
    public static Map<Object, Object> getCell(List<String> rows) {
